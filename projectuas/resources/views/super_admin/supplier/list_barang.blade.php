...
<section class="ftco-section">
    <div class="container"><br>
        <div class="row">
            <div class="col-12">
                <button id="orderBarang" type="button" class="btn btn-primary">Order Barang</button>
...
<script>
    $(document).ready(function() {
        ...
        // Event listener untuk tombol "Order Barang"
        $("#orderBarang").click(function() {
            ...
            if (data.length === 0) {
                Swal.fire({
                    title: 'Peringatan!',
                    text: 'Pilih minimal satu barang sebelum memesan.',
                    icon: 'warning',
                });
                return;
            }
            ...
            Swal.fire({
                ...
                text: 'Apakah Anda yakin ingin memesan barang ini?',
                icon: 'question',
